    ...
    while ((choice = menu()) != Emenu::EXIT)
    {
        ...
        case DEPOSIT_AMOUNT:
            ...
            if (acctodepositindex != -1)
            {
                ...
                try
                {
                    ...
                    {
                        throw inSufficientFundsException("Enter valid amount");
                    }
                }
        ...
        case WITHDRAW_AMOUNT:
            ...
            if (acctowithdrawindex != -1)
            {
                ...
                try
                {
                    if ((arr[index]->getBalance()) > amount)
                    {
                    ...
                    {
                        throw inSufficientFundsException("balance not sufficient to withdraw ");
                    }
                }
                catch (inSufficientFundsException &e)
                {
